    ...
    const effectivePartA = [...noPart, ...partA];
      ...
      const hasPartA = effectivePartA.length > 0;
        const hasPartB = partB.length > 0;
          ...
          // Show Part A / Part B headings ONLY when both parts exist
            const showPartHeadings = hasPartA && hasPartB;

              function buildPartRows(label, exps) {
                  if (exps.length === 0) return "";

                      // KEEP YOUR ORIGINAL EXPERIMENT ROW GENERATION
                          const dataRows = exps.map(exp => {

                                const parts = splitExperimentContent(
                                        buildHTML(exp.exp || "").trim()
                                              );
                                                                                                      ...
                                                                                                      <td style="text-align:left;">
                                                                                                                  ${part}
                                                                                                                                          ...
                                                                                                                                          `).join("");
                                                                                                                                                        ...
                                                                                                                                                        // Add Part A / Part B heading ONLY if BOTH parts exist
                                                                                                                                                            if (showPartHeadings) {
                                                                                                                                                                  const headerRow = `
                                                                                                                                                                          <tr>
                                                                                                                                                                                    <td colspan="2"
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        ${label}
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                `;
                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                      return headerRow + dataRows;
                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                              // If only one part exists, DON'T show Part heading
                                                                                                                                                                                                                                                                                                  return dataRows;
                                                                                                                                                                                                                                                                                                    }
