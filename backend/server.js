...
if (hasAnyPart) {
    ...
    const effectivePartA = [...noPart, ...partA];
      ...
      // Check whether Part A and Part B actually contain experiments
        const hasPartA = effectivePartA.length > 0;
          const hasPartB = partB.length > 0;

            // Show Part A / Part B headings ONLY when both parts have experiments
              const showPartHeadings = hasPartA && hasPartB;

                // Build rows for a particular part
                  function buildPartRows(label, exps) {

                      if (exps.length === 0) return "";

                          // Your existing experiment-row generation
                              const rows = exps.map(exp => {
                                    const content = splitExperimentContent(
                                            exp.exp || ""
                                                  );
                                                                                                          ...
                                                                                                          <td style="text-align:left;">
                                                                                                                      ${part}
                                                                                                                                              ...
                                                                                                                                              `).join("");
                                                                                                                                                      ...
                                                                                                                                                      // If both Part A and Part B exist,
                                                                                                                                                          // display the Part A / Part B heading.
                                                                                                                                                              if (showPartHeadings) {
                                                                                                                                                                    return `
                                                                                                                                                                            <tr>
                                                                                                                                                                                      <td colspan="2"
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    ${rows}
                                                                                                                                                                                                                                                                                          `;
                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                  // If only one part exists,
                                                                                                                                                                                                                                                                                                      // display ONLY the experiment rows.
                                                                                                                                                                                                                                                                                                          return rows;
                                                                                                                                                                                                                                                                                                            }
